$(function () {
    ...
    var loadAndShowDialog = function (id, link, url,txt) {
        ...
        $.get(url + separator + 'content=1')
            .done(function (content) {
                ...
                dialogs[id] = $('<div class="modal" id="ajaxModal"><div class="modal-body">' + content + '</div></div>')
    ...
    var links = ['#loginLink', '#registerLink','#ChangePasswordLink'];
    ...
    $.each(links, function (i, id) {
        $(id).click(function (e) {
            ...
            if (!dialogs[id]) {
                ...
                loadAndShowDialog(id, link, url,txt);
            } else {
