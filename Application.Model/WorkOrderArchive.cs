...
namespace Application.Model
{
    ...
    public partial class WorkOrderArchive : Entity<WorkOrderArchive>
    {
        public WorkOrderArchive()
        {
            this.ReportArchives = new HashSet<ReportArchive>();
            this.SampleArchives = new HashSet<SampleArchive>();
        }
        ...
        public virtual ICollection<ReportArchive> ReportArchives { get; set; }
        public virtual ICollection<SampleArchive> SampleArchives { get; set; }
    }
}
